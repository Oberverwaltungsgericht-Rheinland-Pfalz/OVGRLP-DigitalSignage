...
export const TEMPLATES: any[] = [NjzSaalComponent, EdvgtSteleComponent, NjzFoyerComponent, NjzkhFoyerComponent];

export { NjzSaalComponent, EdvgtSteleComponent, NjzFoyerComponent, NjzkhFoyerComponent };
